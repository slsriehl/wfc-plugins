...
<!-- TODO: development (Liam) - backend php files will eventually populate data that the php backend gets from the database.  for now, wherever you see php loops that are supposed to iterate blocks of html filling in this data, you can hard code a couple of identical html blocks with fake data to test your js with and delete the php stuff for now -->
...
<!--[if gte IE 9]><!--><html lang="en"><!--<![endif]-->
	<head>
		...
		<meta name="viewport" content="width=device-width,initial-scale=1" />
			<title></title>
		<meta name="author" content="Sarah Schieffer Riehl &amp; Liam Langert" />
	...
	<body>
		<div class="wrap">
			...
			<form method="POST" name="form_create_event" id="form_create_event">
				...
				<div class='form-group-level-1'>
					...
					<div class='form-group-input-text form-group-level-2' id="foo">
		...
		<!-- normally jquery would come from the wordpress files but we're developing this outside of the wordpress environment so for now we're getting it here -->
		<!-- js libraries come before the js we write so that we have access to their functions/methods -->
